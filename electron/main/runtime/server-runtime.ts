  ...
  async getDashboardStats(): Promise<DashboardStats> {
    if (!this.running) {
      return {
        ...
        femaleJudokas: 0,
        weighedJudokas: 0,
        maleWeighedJudokas: 0,
        femaleWeighedJudokas: 0,
        connectedClients: 0,
    ...
    try {
      ...
      return {
        ...
        weighedJudokas: total.weighed ?? 0,
        maleWeighedJudokas: total.maleWeighed ?? 0,
        femaleWeighedJudokas: total.femaleWeighed ?? 0,
